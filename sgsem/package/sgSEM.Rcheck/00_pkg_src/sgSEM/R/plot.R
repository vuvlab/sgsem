##' Plot semi-gSEM result
##' plot.sgSEM plots a structural equation network model diagram based on best functional form for each selected pairwise variable.
##' @title Plotting of Semi-gSEM
##' @param x The returned list from sgSEM. Plotting uses the first element of this list (res.print) in which the first column of it is response, second column is variable and other columns are corresponding best functional form, r-squared, adj-r-squared, P-value1, P-value2 and P-value3.
##' @param cutoff A threshold value for adjusted R-squared. Solid lines represent relationship with adjusted R-sqr of greater than the cutoff and dotted lines with less than the cutoff. The default is 0.2.
