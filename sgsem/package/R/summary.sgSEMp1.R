##' summarize sgSEM principle 1 result
##' 
##' summary.sgSEMp1 gives a summary about the sgSEm-Principle 1 analysis. 
##'
...
summary.sgSEMp1 <- function(object, ...){
  cat("sgSEM principle 1 Done \n")
  cat("\n")
  cat("Stressor:", colnames(object$bestModels)[1], "\n")
