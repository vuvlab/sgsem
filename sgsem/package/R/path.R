...
##' @param x object of class "sgSEM", which is the return value of function sgSEM().
...
path <- function(x, from, to, round = 3){
  ...
  ### Model Names
  ###------------------
  ## IMPORTANT: These model names are taken from the main 'sgSEM' function.
  ## It needs to be updated if they are changed in 'sgSEM'
